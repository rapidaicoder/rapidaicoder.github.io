...
<section class="hero-maclaw section">
  <div class="container" style="text-align: center; padding-top: 60px;">
    <span class="maclaw-badge">企业数智助手</span>
    <h1 class="hero-title">码卡龙 <span class="title-en">MaClaw</span></h1>
    <p class="hero-subtitle">企业数字化转型的智能办公伙伴<br/>AI驱动的工作流自动化，提升团队效率</p>
...
<section class="enterprise-section section">
  <div class="container">
    <h2 class="section-title">企业数智能力</h2>
...
<section class="workflow-section section">
  <div class="container">
    ...
    <p class="section-subtitle">企业级专业场景工作流模板</p>
    <div class="workflow-grid">
      <div class="workflow-card">
        <div class="workflow-icon">&#x1F4DD;</div>
        <h3>投标响应</h3>
        <p>招标文件解析、资质响应、技术方案编写、投标文件组装全流程</p>
        <span class="workflow-tag">企业版</span>
      </div>
      <div class="workflow-card">
        <div class="workflow-icon">&#x1F4DC;</div>
        <h3>合同审查</h3>
...
<section class="developer-section section">
  <div class="container">
    <h2 class="section-title">开发者能力</h2>
